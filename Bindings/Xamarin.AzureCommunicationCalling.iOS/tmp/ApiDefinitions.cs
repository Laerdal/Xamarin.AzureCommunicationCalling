...
*/[Protocol (Name = "_TtP24AzureCommunicationCommon23CommunicationIdentifier_")]
	...
	interface ACSCallDelegate
	{
		...
		// @optional -(void)onIsRecordingActiveChanged:(ACSCall * _Nonnull)call :(ACSPropertyChangedEventArgs * _Nonnull)args __attribute__((swift_name("call(_:didChangeRecordingState:)")));
		[Export ("onIsRecordingActiveChanged::")]
		void OnIsRecordingActiveChanged (ACSCall call, ACSPropertyChangedEventArgs args);

		// @optional -(void)onIsTranscriptionActiveChanged:(ACSCall * _Nonnull)call :(ACSPropertyChangedEventArgs * _Nonnull)args __attribute__((swift_name("call(_:didChangeTranscriptionState:)")));
	...
	interface ACSCall
	{
		...
		// -(ACSRemoteParticipant * _Nonnull)addParticipant:(id<CommunicationIdentifier> _Nonnull)participant __attribute__((swift_name("add(participant:)")));
		[Export ("addParticipant:")]
		ACSRemoteParticipant AddParticipant (CommunicationIdentifier participant);

		// -(ACSRemoteParticipant * _Nonnull)addParticipant:(PhoneNumberIdentifier * _Nonnull)participant options:(ACSAddPhoneNumberOptions * _Nullable)options __attribute__((swift_name("add(participant:options:)")));
		[Export ("addParticipant:options:")]
		ACSRemoteParticipant AddParticipant (PhoneNumberIdentifier participant, [NullAllowed] ACSAddPhoneNumberOptions options);
	}
