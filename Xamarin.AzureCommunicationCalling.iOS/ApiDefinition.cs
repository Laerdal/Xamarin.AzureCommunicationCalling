...
namespace Xamarin.AzureCommunicationCalling.iOS
{
	...
	*/
	...
	interface CommunicationUserCredential
	{
        ...
        // TODO: Compiler crashes on this binding (The nested Action<Action< part...)
	...
	interface ACSRemoteParticipantDelegate
	{
		...
		// @optional -(void)onScreenSharingStreamsUpdated:(ACSRemoteParticipant *)remoteParticipant :(ACSRemoteVideoStreamsEventArgs *)args;
		[Export("onScreenSharingStreamsUpdated::")]
	...
	interface ACSInternalTokenProvider
	{
		...
		[Export("setTokenWithToken:accountIdentity:displayName:")]
		void SetTokenWithToken(string token, string accountIdentity, string displayName);
	...
	interface ACSCall
	{
		...
		// @property (readonly, retain) ACSAcsError * callEndReason;
		[Export("callEndReason", ArgumentSemantic.Retain)]
		ACSAcsError CallEndReason { get; }
	...
	interface ACSRemoteParticipant
	{
		...
		// @property (readonly, copy) NSArray<ACSRemoteVideoStream *> * screenSharingStreams;
		[Export("screenSharingStreams", ArgumentSemantic.Copy)]
		ACSRemoteVideoStream[] ScreenSharingStreams { get; }
	...
	[BaseType(typeof(NSObject))]
	interface ACSCompositeAudioDeviceInfo
	{
		// -(void)dealloc;
		[Export("dealloc")]
		void Dealloc();
		...
		// @property (readonly, retain) ACSAudioDeviceInfo * speakers;
		[Export("speakers", ArgumentSemantic.Retain)]
		ACSAudioDeviceInfo Speakers { get; }

		// @property (readonly) BOOL isPcInternalDevice;
		[Export("isPcInternalDevice")]
		bool IsPcInternalDevice { get; }

		// @property (readonly) ACSCompositeAudioDeviceType compositeAudioDeviceType;
		[Export("compositeAudioDeviceType")]
		ACSCompositeAudioDeviceType CompositeAudioDeviceType { get; }
	}
}
