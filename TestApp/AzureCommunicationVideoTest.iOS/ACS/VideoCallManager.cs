...
[assembly:Dependency(typeof(AzureCommunicationVideoTest.iOS.ACS.VideoCallManager))]
namespace AzureCommunicationVideoTest.iOS.ACS
{
    public class VideoCallManager : IACSCallingManager
    {
        ...
        public VideoCallManager()
        {
            ...
            _videoCallbackManager = new VideoCallbackManager(RemoteVideoStreamAdded);
        }
